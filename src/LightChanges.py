...
#    if diffTime > 0.05:
#        print "Dark---------------------";
    lightChange=mean[0]-self.prevMean
    diffTimeChange=diffTime-self.prevdiffTime
    self.prevMean=mean[0];
    self.prevdiffTime=diffTime
#    print "changes:"+str(lightChange)
    if lightChange<-20 and diffTimeChange>0.2 and diffTime>0.4:
        print "changes:"+str(lightChange)
        print diffTime
        print "somebody turn off the light------------------"
    elif lightChange>20 and diffTimeChange<0.2:
        print "changes:"+str(lightChange)
        print diffTime
        print "somebody turn on the light------------------"
    #print stdv
